package com.example.demo.apns.service;

import com.example.demo.common.GeneralException;
import com.example.demo.apns.config.ApnsConfig;
...
public class ApnsJwtService {
    ...
    public String getToken() {
        try{
            ...
            throw new GeneralException("Failed to sign APNs JWS", e);
        }
    }
    ...
    private ECPrivateKey loadPrivateKey() {
        try{
            ...
            throw new GeneralException("Failed to load APNs private key", e);
        }
    }
}
